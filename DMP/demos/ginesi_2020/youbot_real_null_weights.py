...
plt.text(x0[0] + 0.1, x0[1], 'x_0', fontsize=fs)
plt.text(xg[0] + 0.1, xg[1], 'g', fontsize=fs)
plt.xlabel('xm', fontsize=fs)
plt.ylabel('ym', fontsize=fs)
plt.axis('scaled')
plt.xlim(-0.75, 0.75)
if savefig:
...
if saveframes:
    for n in range(int(x_track_dynamic.shape[0] / 10) - 1):
        ...
        plt.plot(x0[0], x0[1], '.k')
        plt.plot(xg[0], xg[1], '.k')
        plt.text(x0[0] + 0.1, x0[1], 'x0', fontsize=fs)
        plt.text(xg[0] + 0.1, xg[1], 'g', fontsize=fs)
...
plt.axvline(x=t_presence[0], color='k', linestyle='--')
plt.axvline(x=t_presence[1], color='k', linestyle='--')
plt.ylabel(r'ym', fontsize=fs)
plt.xlabel(r'ts', fontsize=fs)
if savefig:
...
plt.plot(x0[0], x0[1], '.k')
plt.plot(xg[0], xg[1], '.k')
plt.text(x0[0] + 0.1, x0[1], r'x_0 $', fontsize=fs)
plt.text(xg[0] + 0.1, xg[1], r'g$', fontsize=fs)
plt.xlabel(r'xm', fontsize=fs)
plt.ylabel(r'ym', fontsize=fs)
plt.axis('scaled')
plt.xlim(-0.75, 0.75)
if savefig:
...
if saveframes:
    for n in range(int(x_track_dynamic.shape[0] / 10) - 1):
        ...
        plt.plot(x0[0], x0[1], '.k')
        plt.plot(xg[0], xg[1], '.k')
        plt.text(x0[0] + 0.1, x0[1], r'x0', fontsize=fs)
        plt.text(xg[0] + 0.1, xg[1], r'$ \mathbf{g} $', fontsize=fs)
        plt.xlabel(r'$x[\texttt{m}]$', fontsize=fs)
        plt.ylabel(r'$y[\texttt{m}]$', fontsize=fs)
        plt.axis('scaled')
