...
class DMPs_cartesian_(object):
    ...
    def __init__(self,
        ...
        self.alpha_s_ = copy.deepcopy(alpha_s)
    ...
    def update_alphas(self, distance):
        self.cs.alpha_s = self.alpha_s_*(1 - np.exp(-distance))
        # pdb.set_trace()
        # return None

    def step(self, tau = 1.0, error = 0.0, external_force = None,
        adapt=False, tols=None, distance=0.0, **kwargs):
        '''
