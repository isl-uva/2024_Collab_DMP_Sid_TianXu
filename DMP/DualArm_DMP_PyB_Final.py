...
def gen_3d_plot():
    ...
    x1_ref, y1_ref, z1_ref = ref[0,:].tolist(), ref[1,:].tolist(), ref[2,:].tolist()
    split_1 = len(x1_positions_m) // 3
    split_2 = 2 * len(x1_positions_m) // 3
    ...
    x2_ref, y2_ref, z2_ref = ref2[0,:].tolist(), ref2[1,:].tolist(), ref2[2,:].tolist()
    split_1 = len(x1_positions_m) // 3
    split_2 = 2 * len(x1_positions_m) // 3
    ...
    ax1.scatter(x1_ref1, y1_ref1, z1_ref1, color='black', label='Reference 1')
    ax1.scatter(x2_ref1, y2_ref1, z2_ref1, color='pink', label='Reference 2')
    ...
    ax1.scatter(x1_ref2, y1_ref2, z1_ref2, color='black', label='Reference 1')
    ax1.scatter(x2_ref2, y2_ref2, z2_ref2, color='pink', label='Reference 2')
    ...
    ax1.scatter(x1_ref3, y1_ref3, z1_ref3, color='black', label='Reference 1')
    ax1.scatter(x2_ref3, y2_ref3, z2_ref3, color='pink', label='Reference 2')
