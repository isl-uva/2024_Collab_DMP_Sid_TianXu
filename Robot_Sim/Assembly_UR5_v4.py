...
def init_setup_robot():
    ...
    table_vis_id = p.createVisualShape(shapeType=p.GEOM_BOX,halfExtents=[0.4,0.6,offset[2]],visualFramePosition=[0, 0, 0], rgbaColor=[0.5,0.4,0.0, 1]) #rgbaColor=[0.6, 0.4, 0, 1])
...
if __name__=="__main__":
    ...
    # start_pose = [0., 0., -2.137, 1.432, -0.915, -1.591, 0.071, 0]
    start_pose = [0., 0. -0.5, -2.537, 1.432+0.5, -0.915, -1.591, 0.071, 0]
    num_joints = 8
    [p.resetJointState(robot_id, idx, start_pose[idx]) for idx in range(num_joints)]
